...
class Error401(BaseModel):
    name: typing.Optional[Literal["AUTHENTICATION_FAILURE"]] = Field(None, alias='name')

    message: typing.Optional[Literal["Authentication failed due to missing authorization header, or invalid authentication credentials."]] = Field(None, alias='message')
