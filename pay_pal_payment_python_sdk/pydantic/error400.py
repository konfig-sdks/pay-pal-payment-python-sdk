...
class Error400(BaseModel):
    name: typing.Optional[Literal["INVALID_REQUEST"]] = Field(None, alias='name')

    message: typing.Optional[Literal["Request is not well-formed, syntactically incorrect, or violates schema."]] = Field(None, alias='message')
