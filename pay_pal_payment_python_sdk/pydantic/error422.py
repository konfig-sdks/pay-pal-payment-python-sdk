...
class Error422(BaseModel):
    name: typing.Optional[Literal["UNPROCESSABLE_ENTITY"]] = Field(None, alias='name')

    message: typing.Optional[Literal["The requested action could not be performed, semantically incorrect, or failed business validation."]] = Field(None, alias='message')
