...
class Error415(BaseModel):
    name: typing.Optional[Literal["UNSUPPORTED_MEDIA_TYPE"]] = Field(None, alias='name')

    message: typing.Optional[Literal["The server does not support the request payload's media type."]] = Field(None, alias='message')
