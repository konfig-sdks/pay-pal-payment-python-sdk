...
class Error409(BaseModel):
    name: typing.Optional[Literal["RESOURCE_CONFLICT"]] = Field(None, alias='name')

    message: typing.Optional[Literal["The server has detected a conflict while processing this request."]] = Field(None, alias='message')
