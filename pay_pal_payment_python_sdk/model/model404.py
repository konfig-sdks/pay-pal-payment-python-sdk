                                ...
                                class MetaOapg:
                                    ...
                                    class properties:
                                        ...
                                        class description(
                                            ...
                                            class MetaOapg:
                                                enum_value_to_name = {
                                                    "Specified resource ID does not exist. Please check the resource ID and try again.": "SPECIFIED_RESOURCE_ID_DOES_NOT_EXIST__PLEASE_CHECK_THE_RESOURCE_ID_AND_TRY_AGAIN_",
                                                }
                                            
                                            @schemas.classproperty
                                            def SPECIFIED_RESOURCE_ID_DOES_NOT_EXIST__PLEASE_CHECK_THE_RESOURCE_ID_AND_TRY_AGAIN_(cls):
                                                return cls("Specified resource ID does not exist. Please check the resource ID and try again.")
                                        ...
                                        class issue(
                                            ...
                                            @schemas.classproperty
                                            def INVALID_RESOURCE_ID(cls):
                                                return cls("INVALID_RESOURCE_ID")
                                        __annotations__ = {
