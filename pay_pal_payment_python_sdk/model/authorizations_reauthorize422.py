                                ...
                                class MetaOapg:
                                    ...
                                    class properties:
                                        ...
                                        class description(
                                            ...
                                            class MetaOapg:
                                                enum_value_to_name = {
                                                    "A reauthorize cannot be attempted on an authorization_id that is the result of a prior reauthorization or on an authorization made on an Order saved using the `v2/orders/id/save` API.": "A_REAUTHORIZE_CANNOT_BE_ATTEMPTED_ON_AN_AUTHORIZATION_ID_THAT_IS_THE_RESULT_OF_A_PRIOR_REAUTHORIZATION_OR_ON_AN_AUTHORIZATION_MADE_ON_AN_ORDER_SAVED_USING_THE_V2_ORDERS_ID_SAVE_API_",
                                                }
                                ...
                                class MetaOapg:
                                    ...
                                    class properties:
                                        ...
                                        class description(
                                            ...
                                            class MetaOapg:
                                                enum_value_to_name = {
                                                    "The currency specified during reauthorization should be the same as the currency specified in the original authorization. Please check the currency of the authorization for which you are trying to reauthorize and try again.": "THE_CURRENCY_SPECIFIED_DURING_REAUTHORIZATION_SHOULD_BE_THE_SAME_AS_THE_CURRENCY_SPECIFIED_IN_THE_ORIGINAL_AUTHORIZATION__PLEASE_CHECK_THE_CURRENCY_OF_THE_AUTHORIZATION_FOR_WHICH_YOU_ARE_TRYING_TO_REAUTHORIZE_AND_TRY_AGAIN_",
                                                }
                                        ...
                                        class issue(
                                            ...
                                            class MetaOapg:
                                                enum_value_to_name = {
                                                    "AUTH_CURRENCY_MISMATCH": "AUTH_CURRENCY_MISMATCH",
                                                }
