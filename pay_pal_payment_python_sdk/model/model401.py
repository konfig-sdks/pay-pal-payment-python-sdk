                                ...
                                class MetaOapg:
                                    ...
                                    class properties:
                                        ...
                                        class description(
                                            ...
                                            class MetaOapg:
                                                enum_value_to_name = {
                                                    "Account validations failed for the user.": "ACCOUNT_VALIDATIONS_FAILED_FOR_THE_USER_",
                                                }
                                            
                                            @schemas.classproperty
                                            def ACCOUNT_VALIDATIONS_FAILED_FOR_THE_USER_(cls):
                                                return cls("Account validations failed for the user.")
                                        ...
                                        class issue(
                                            ...
                                            @schemas.classproperty
                                            def INVALID_ACCOUNT_STATUS(cls):
                                                return cls("INVALID_ACCOUNT_STATUS")
                                        __annotations__ = {
