    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class message(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "Authorization failed due to insufficient permissions.": "AUTHORIZATION_FAILED_DUE_TO_INSUFFICIENT_PERMISSIONS_",
                    }
                
                @schemas.classproperty
                def AUTHORIZATION_FAILED_DUE_TO_INSUFFICIENT_PERMISSIONS_(cls):
                    return cls("Authorization failed due to insufficient permissions.")
