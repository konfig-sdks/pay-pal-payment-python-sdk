    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class message(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "Request is not well-formed, syntactically incorrect, or violates schema.": "REQUEST_IS_NOT_WELLFORMED_SYNTACTICALLY_INCORRECT_OR_VIOLATES_SCHEMA_",
                    }
                
                @schemas.classproperty
                def REQUEST_IS_NOT_WELLFORMED_SYNTACTICALLY_INCORRECT_OR_VIOLATES_SCHEMA_(cls):
                    return cls("Request is not well-formed, syntactically incorrect, or violates schema.")
