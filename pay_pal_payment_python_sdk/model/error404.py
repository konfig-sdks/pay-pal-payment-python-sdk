    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class message(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "The specified resource does not exist.": "THE_SPECIFIED_RESOURCE_DOES_NOT_EXIST_",
                    }
                
                @schemas.classproperty
                def THE_SPECIFIED_RESOURCE_DOES_NOT_EXIST_(cls):
                    return cls("The specified resource does not exist.")
