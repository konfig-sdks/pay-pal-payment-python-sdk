    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class message(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "The server has detected a conflict while processing this request.": "THE_SERVER_HAS_DETECTED_A_CONFLICT_WHILE_PROCESSING_THIS_REQUEST_",
                    }
                
                @schemas.classproperty
                def THE_SERVER_HAS_DETECTED_A_CONFLICT_WHILE_PROCESSING_THIS_REQUEST_(cls):
                    return cls("The server has detected a conflict while processing this request.")
