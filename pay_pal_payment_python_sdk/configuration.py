...
from pay_pal_payment_python_sdk.exceptions_base import ApiValueError
from pay_pal_payment_python_sdk.exceptions import ClientConfigurationError
from pay_pal_payment_python_sdk.exceptions import InvalidHostConfigurationError
...
class Configuration(object):
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api-m.sandbox.paypal.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("pay_pal_payment_python_sdk")
...
class OAuth:
    def __init__(self, client_id: typing.AnyStr, client_secret: typing.AnyStr, token_url: str = "/v1/oauth2/token") -> None:
